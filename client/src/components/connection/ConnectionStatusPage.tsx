...
const ConnectionError = () => {
    ...
    return (
        <>
            <h1 className="mb-6 text-3xl font-bold text-white">Work Room Connection Error</h1>
            <p className="mb-8 max-w-md text-lg text-gray-300">
                Oops! We couldn't connect to the Work Room. Please check your internet connection and try again.
            </p>
